...
public class BedrockStateGroups {
    ...
    public static final StateMappingGroup COMPOSTER = new StateMappingGroup.Builder()
            ...
            .build();
    public static final VersionedStateMappingGroup CONNECTABLE_HORIZONTAL = new VersionedStateMappingGroup.Builder()
            .defaults(new StateMappingGroup.Builder()
                    .defaultOutput(VanillaBlockStates.NORTH, Bool.FALSE)
                    .defaultOutput(VanillaBlockStates.EAST, Bool.FALSE)
                    .defaultOutput(VanillaBlockStates.SOUTH, Bool.FALSE)
                    .defaultOutput(VanillaBlockStates.WEST, Bool.FALSE)
                    .build())
            // 1.26.50 added the connection states
            .version(new Version(1, 26, 50), new StateMappingGroup.Builder()
                    .state("minecraft:connection_north", VanillaBlockStates.NORTH, BedrockStateTypes.BOOL)
                    .state("minecraft:connection_east", VanillaBlockStates.EAST, BedrockStateTypes.BOOL)
                    .state("minecraft:connection_south", VanillaBlockStates.SOUTH, BedrockStateTypes.BOOL)
                    .state("minecraft:connection_west", VanillaBlockStates.WEST, BedrockStateTypes.BOOL)
                    .build())
            .build();
    ...
    public static final StateMappingGroup SOUL_FIRE = new StateMappingGroup.Builder()
            .state("age", VanillaBlockStates.AGE_15, BedrockStateTypes.AGE_15)
            .build();
    public static final VersionedStateMappingGroup STAIRS = new VersionedStateMappingGroup.Builder()
            .defaults(new StateMappingGroup.Builder()
                    ...
                    .build())
            // 1.26.50 added the corner state
            .version(new Version(1, 26, 50), new StateMappingGroup.Builder()
                    .state("weirdo_direction", VanillaBlockStates.FACING_HORIZONTAL, BedrockStateTypes.WEIRDO_DIRECTION)
                    .state("upside_down_bit", VanillaBlockStates.HALF, BedrockStateTypes.HALF)
                    .state("minecraft:corner", VanillaBlockStates.STAIR_SHAPE, BedrockStateTypes.CORNER)
                    .build())
            .build();
    ...
    public static final VersionedStateMappingGroup TRIPWIRE = new VersionedStateMappingGroup.Builder()
            .defaults(new StateMappingGroup.Builder()
                    .state("attached_bit", VanillaBlockStates.ATTACHED, BedrockStateTypes.BOOL)
