package com.hivemc.chunker.conversion.encoding.bedrock.v1_26_40.reader;
...
public class LevelReader extends com.hivemc.chunker.conversion.encoding.bedrock.v1_26_30.reader.LevelReader {
    ...
    public @Nullable Object readCustomLevelSetting(@NotNull CompoundTag root, @NotNull ChunkerLevelSettings chunkerLevelSettings, @NotNull String targetName, @NotNull Class<?> type) {
        ...
        if (targetName.equals("AutumnDrop2026")) {
            ...
            return experiments.getByte("y_2026_drop_3", (byte) 0) == (byte) 1;
        }
